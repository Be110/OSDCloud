...
Write-Host "1: Zero-Touch Win10 21H2 | Deutsch | Enterprise" -ForegroundColor Yellow
Write-Host "2: Zero-Touch Win10 21H2 | English | Enterprise" -ForegroundColor Yellow
Write-Host "3: Zero-Touch Win10 21H2 | Czech | Enterprise" -ForegroundColor Yellow
