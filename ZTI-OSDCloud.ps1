...
Write-Host "7: Zero-Touch Win11 23H2 | German | Pro" -ForegroundColor Yellow
...
switch ($input)
{
    ...
    '7' { Start-OSDCloud -OSLanguage de-de -OSVersion "Windows 11" -OSBuild 23H2 -OSEdition Pro -OSLicense Retail -ZTI }
    '10' { Exit	}
}
